...
import { discordService, EventgetMessageDiscord, EventnotifyUserDiscord} from "./service/discord.service";
...
async function bootstrap() {
  ...
  const user_1_event2 = user_1.getEventByIdInService(user_1_service2.id, "notifyUserDiscord");
  ...
  console.log("=====================================")
  try {
    const node1 = user_1.transformEventToNode(user_1_service.id, user_1_event.id);
    const node2 = user_1.transformEventToNode(user_1_service2.id, user_1_event2.id);
