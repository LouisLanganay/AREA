...
export default function Settings() {
  ...
  const [openAIToken, setOpenAIToken] = useState(Cookies.get('openaiToken') || '');
  ...
  const handleOpenAITokenChange = (value: string) => {
    setOpenAIToken(value);
    Cookies.set('openaiToken', value);
    toast({
      description: t('settings.security.openai.saveSuccess'),
      variant: 'success',
    });
  };
            ...
            <CardContent className='space-y-4'>
              <div className='space-y-2'>
                <Label htmlFor='openai-token'>
                  {t('settings.security.openai.label')}
                </Label>
                <Input
                  id='openai-token'
                  type='password'
                ...
                />
                <p className='text-sm text-muted-foreground'>
                  {t('settings.security.openai.description')}
                </p>
              </div>
              <div className='flex items-center justify-between'>
                <div className='space-y-0.5'>
